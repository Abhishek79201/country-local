...
const StayBanner = () => (
  <div className="w-full">
    ...
    <div className="flex h-auto w-full flex-wrap items-center rounded-xl shadow-xl md:flex-nowrap lg:h-[198px] ">
      ...
      <div className="relative max-w-[505px]  p-4 pt-6 lg:pt-0 ">
        ...
        {[1, 2, 3].map((item) => (
          <div className="flex items-center gap-2 pt-1 " key={item}>
