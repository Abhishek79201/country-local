                        ...
                        <div className="flex flex-wrap gap-y-3 gap-x-3">
                          {[
                            ...
                            >
                              <button
                                type="button"
                                className="h-[44px] w-full rounded-lg border border-[#DCDCDC] text-sm font-semibold text-[#444] hover:border-[#E71575] hover:bg-[#E71575] hover:text-white md:text-[15px]"
                              >
                                {item}
                              </button>
                            </div>
